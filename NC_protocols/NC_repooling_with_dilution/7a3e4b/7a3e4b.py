def get_values(*names):
    import json
    _all_values = json.loads("""{"volumes_csv":"1,2,3","pip_model":"p20_single_gen2","pip_mount":"left","sp_type":"biorad_96_wellplate_200ul_pcr","dp_type":"biorad_96_wellplate_200ul_pcr","tip_reuse":"always"}""")
