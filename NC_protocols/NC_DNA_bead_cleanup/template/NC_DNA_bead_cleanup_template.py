...
def get_values(*names):
    ...
    _all_values = json.loads("""{
        ...
        "input_plate_type":"<input_plate_type>",
        "output_plate_type":"<output_plate_type>",
        "sample_number":<sample_number>,
        "sample_volume":<sample_volume>,
        "bead_ratio":<bead_ratio>,
        "beads_position":<beads_position>,
        "ethanol_position":<ethanol_position>,
        "elution_buffer_position":<elution_buffer_position>,
        "waste_position":<waste_position>,
        "elution_buffer_volume":<elution_buffer_volume>,
